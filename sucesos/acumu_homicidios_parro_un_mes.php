<?php
	...
	$query_homici_mes = $db->Prepare("SELECT count(*) AS acu_mes
		FROM `sucesos`
		WHERE `municipio_id` = $muni_id  AND year(fecha_suceso) =$ano AND MONTH(fecha_suceso)=$mes AND delito_detalle_id = $delito_deta");

	$query_homici_mes_ant = $db->Prepare("SELECT count(*) AS acu_mes_ant
		FROM `sucesos`
		WHERE `municipio_id` = $muni_id  AND year(fecha_suceso) =$ano AND MONTH(fecha_suceso)=(Month(now())-1) AND delito_detalle_id = $delito_deta");
	//echo $query_homici_mes."<BR>";
	...
	$query_homici_mes_sf = $db->Prepare("SELECT count(*) AS acu_mes_sf
		...
		WHERE s.municipio_id = $muni_id AND year(fecha_suceso) =$ano AND MONTH(fecha_suceso)=$mes
				...
				<table class="table table-responsive table-bordered" id="datatablesss">
					...
					<tbody>
						...
						<tr>
							...
							<th><a target="_blank" href="lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_cacha?>" class="btn btn-primary btn-sm"</a><?php echo $acu_mes_parr_cacha; ?></th>
							<th><a target="_blank" href="lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_chi?>" class="btn btn-primary btn-sm"</a><?php echo $acu_mes_parr_chi; ?></th>
							<th><a target="_blank" href="lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_dalla?>" class="btn btn-primary btn-sm"</a><?php echo $acu_mes_parr_dalla; ?></th>
							<th><a target="_blank" href="lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_once?>" class="btn btn-primary btn-sm"</a><?php echo $acu_mes_parr_once; ?></th>
							<th><a target="_blank" href="lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_pozo?>" class="btn btn-primary btn-sm"</a><?php echo $acu_mes_parr_pozo; ?></th>
							<th><a target="_blank" href="lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_simon?>" class="btn btn-primary btn-sm"</a><?php echo $acu_mes_parr_simon; ?></th>
							<th><a target="_blank" href="lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_unare?>" class="btn btn-primary btn-sm"</a><?php echo $acu_mes_parr_unare; ?></th>
							<th><a target="_blank" href="lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_uni?>" class="btn btn-primary btn-sm"</a><?php echo $acu_mes_parr_univer; ?></th>
							<th><a target="_blank" href="lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_vista?>" class="btn btn-primary btn-sm"</a><?php echo $acu_mes_parr_vista; ?></th>
							<th><a target="_blank" href="lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_yoco?>" class="btn btn-primary btn-sm"</a><?php echo $acu_mes_parr_yoco; ?></th>
							<th><?php echo " "; ?></th>
							<th><?php echo " "; ?></th>
						</tr>
					</tbody>
