<?php
	...
	$sql_sucesos = $db->Prepare("SELECT suceso_id, fecha_suceso As fecha_suceso, delito_id, delito_detalle_id,
		...
		WHERE YEAR(fecha_suceso) = '$ano' AND MONTH(fecha_suceso) = '$mes' AND s.municipio_id = $muni_id AND s.delito_detalle_id = $delito_deta");
...
<html lang="en">
<head>
    <title>Listado de Homicidios años meses Caroni</title>
    <meta charset="utf-8">
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="panel panel-primary">
				...
				<div class="panel-heading">Venezuela Segura. Listado des Homicidios Mes: <?php echo $mes_letras;?> A&ntilde;o, <?php echo $ano?> : Municipio Caroni.</div>
					<div class="panel-body">

						<div class="col-xs-12"><?php include '../sucesos/acumu_homicidios_parro_un_mes.php'; ?></div>
