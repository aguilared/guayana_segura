...
<?php
	...
	if (login_check($mysqli) == true && $nivel ==1) : 
		...
		//datos no ingresados diariamente desde esta app fueron tomados de totales en medios digitales y almacenados en esa tabla histo_homicidios
		...
		//$acu_ano = $acu_ano_2016 + $acu_mes + $acu_mes_ant;   // estan hasta julio del historico tomado del correodelcaroni
						...
						<table class="table table-striped table-bordered" id="datatables">
							...
							<?php
								...
								while(!$rs_sucesos->EOF){
									...
									echo '<tr>';
										echo '<td><a class="btn ampliar" href="suceso1.php?suceso_id='.$suceso_id.'" class="btn btn-primary btn-lg">'.$suceso_id.'</a></td>';
	...
	<?php else : ?> <!-- //fin login_check-->
		<p><span class="error">No estás autorizado para acceder a esta página.</span> Please <a href="../index1.php">login</a>.</p>
	<?php endif; ?>
