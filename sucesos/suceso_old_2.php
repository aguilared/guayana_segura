...
$conexion=new Conexion();
	...
	$query_sucesos = $db->Prepare("SELECT suceso_id, fecha_suceso, d.descripcion AS tipo_delito, dd.descripcion AS detalle_delito, titulo, fuente,
		...
		m.descripcion AS municipio, p.descripcion AS parroquia, sector, usuario, s.latitud as latitud, s.longitud AS longitud
		FROM sucesos AS s
		...
		<div class="panel panel-primary">
			<div class="panel-heading">Informacion del Suceso: <?php echo $suceso_id;?>
				...
				<div class="panel-body">
					...
					<h4>Sector: <?php echo $sector;?><a target="_blank" href="maps.php?latitud=<?php echo $latitud;?>&longitud=<?php echo $longitud;?>"><span class="glyphicon glyphicon-star"></span>Maps</a>

					<button type="button" class="btn btn-default btn-sm"> <a target="_blank"  href="frm_modi_suceso.php">
						<span class="glyphicon glyphicon-star"></span> Star</a>
					</button></h4>
...
<a target="_blank"  href="tryit.asp?filename=trybs_ref_btn&amp;stacked=h"><span class="glyphicon glyphicon-star"></span>Try it</a>
