	    ...
	    <div class="panel-body">
            ...
            <table class="table table-striped table-bordered" id="datatables">
		              ...
		              <?php
						...
						$query_sucesos = $db->Prepare("SELECT suceso_id, fecha_suceso, delito_id, delito_detalle_id, titulo, nombre_victima, fuente
						FROM sucesos ORDER BY fecha_suceso DESC");
					 ...
					 while(!$rs_sucesos->EOF){
						echo '<tr>';
							...
							echo '<td>'. normaliza($rs_sucesos->Fields('fecha_suceso')) . '</td>'; 
