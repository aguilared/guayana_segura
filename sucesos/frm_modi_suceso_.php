<?php
	...
	//$suceso_id = 1100;
	$query_suceso = $db->Prepare("SELECT fecha_suceso, hora, delito_id, delito_detalle_id, titulo, fuente, otra_fuente1, otra_fuente2, nombre_victima, sexo, edad, profesion_id, tipo_arma, estado, municipio_id, parroquia_id,	latitud, longitud, sector, usuario, mi_resena, fecha_creado
	FROM sucesos
          ...
          <div class="form-group">
            ...
            <div class="col-xs-4">
              <select class="form-control input-sm" id="tipo_arma" name="tipo_arma" >
                        <option selected value="0" >Seleccione</option>
                          <option <?php if ($tipo_arma == "1") {
                      echo "\" selected=\"selected\"";}?>>1</option>
                <option <?php if ($tipo_arma == "2") {
