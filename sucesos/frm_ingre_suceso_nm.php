...
<body>
    <form class="form-horizontal">
        <div class="form-group">
            <label class="control-label col-xs-2" for="inputEmail" class="control-label col-xs-2">Email</label>
            <div class="col-xs-10">
                <input type="email" class="form-control" id="inputEmail" placeholder="Email">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-xs-2" for="inputPassword" class="control-label col-xs-2">Password</label>
            <div class="col-xs-10">
        ...
        <div class="form-group">
            <div class="col-xs-offset-2 col-xs-10">
                <div class="checkbox">
                    <label class="control-label col-xs-2"><input type="checkbox"> Remember me</label>
                </div>
            </div>
        </div>
        <div class="form-group">
	    ...
	    <div class="panel-body">
	        <div class="row">
	          ...
	          <form class="form-horizontal" role="form" id="contactform">
	            ...
	            <div class="form-group"><label class="control-label col-xs-2" for="sel1">Delito</label>	              
	            ...
	            <div class="form-group"><label class="control-label col-xs-2" for="sel2">Detalle Delito</label>
               ...
               <div class="form-group"><label class="control-label col-xs-2" for="fuente">Fuente:</label>
                ...
                <div class="form-group"><label class="control-label col-xs-2" for="municipio">Municipio</label>
                ...
                <div class="form-group">
			    	<label class="control-label col-xs-2" for="focusedInput">Nombre Victima:</label>
	              	<input class="form-control" name="nombre_victima" id="nombre_victima" type="text">
			    </div>
			    <div class="clear"></div>
                
                <div class="form-group">
	              <label class="control-label col-xs-2" for="sel3">Sexo</label>
                ...
                <div class="form-group">
	              <label class="control-label col-xs-2" for="focusedInput">Edad:</label>
	              <input class="form-control" name="edad" id="edad" type="text">
	            </div>
                
                <div class="form-group">
	              <label class="control-label col-xs-2" for="sel3">Tipo Arma</label>
                ...
                <div class="form-group">
	              <label class="control-label col-xs-2" for="focusedInput">Latitud:</label>
	              <input class="form-control" name="latitud" id="latitud" type="text">
	            </div>
                
                <div class="form-group">
	              <label class="control-label col-xs-2" for="focusedInput">Longitud:</label>
	              <input class="form-control" name="longitud" id="longitud" type="text">
	            </div>
                <div class="clear"></div>
                
                <div class="form-group">
			    	<label class="control-label col-xs-2" for="focusedInput">Sector:</label>
	              	<input class="form-control" name="sector" id="sector" type="text">
			    </div>
			    <div class="clear"></div>
                
                <div class="form-group">
	              <label class="control-label col-xs-2" for="focusedInput">Ingresado por:</label>
