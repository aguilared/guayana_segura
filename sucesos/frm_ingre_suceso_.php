<?php
	...
	$delito_id = 1;
	$delito_detalle_id = 7;  //defecto homicidio
	$estado_id = 7;			//Defecto Bolivar
	$municipio_id = 3;		//Defecto Caroni
		...
		$(document).ready(function() {
			...
			$("#contactform").validate({
				...
				submitHandler: function(form){
					...
					var dataString = 'fecha='+$('#fecha').val()+'&hora='+$('#hora').val()+'&delito_id='+$('#delito_id').val()+'&delito_detalle_id='+$("select#delito_detalle_id").val()+'&titulo='+$('#titulo').val()+'&fuente='+$('#fuente').val()+'&otra_fuente1='+$('#otra_fuente1').val()+'&otra_fuente2='+$('#otra_fuente2').val()+'&municipio='+$("select#municipio").val()+'&parroquia='+$("select#parroquia").val()+'&nombre_victima='+$('#nombre_victima').val()+'&sexo='+$("select#sexo").val()+'&edad='+$('#edad').val()+'&profesion='+$("select#profesion").val()+'&tipo_arma='+$("select#tipo_arma").val()+'&sector='+$('#sector').val()+'&resena='+$('#resena').val()+'&latitud='+$('#latitud').val()+'&longitud='+$('#longitud').val()+'&usuario='+$('#usuario').val();
					//alert(dataString);
					$.ajax({
						type: "POST",
