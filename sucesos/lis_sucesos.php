<?php
	...
	$sql_sucesos_old = $db->Prepare("SELECT suceso_id, fecha_suceso As fecha_suceso, delito_id, delito_detalle_id,
...
<html lang="en">
<head>
    <title>Listado Historico de Sucesos Estado Bolivar</title>
    <meta charset="utf-8">
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="panel panel-primary">
				<div class="panel-heading">Listado Historico de Sucesos, Estado Bolivar, Venezuela</div>
							...
							<?php 
								...
								while(!$rs_sucesos_a_m->EOF){
									echo '<tr>';
										...
										echo '<td><a target="_blank" href="lis_sucesos_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes1.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('1').'</a></td>';
										echo '<td><a target="_blank" href="lis_sucesos_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes2.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('2').'</a></td>';
										echo '<td><a target="_blank" href="lis_sucesos_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes3.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('3').'</a></td>';
										echo '<td><a target="_blank" href="lis_sucesos_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes4.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('4').'</a></td>';
										echo '<td><a target="_blank" href="lis_sucesos_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes5.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('5').'</a></td>';
										echo '<td><a target="_blank" href="lis_sucesos_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes6.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('6').'</a></td>';
										echo '<td><a target="_blank" href="lis_sucesos_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes7.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('7').'</a></td>';
										echo '<td><a target="_blank" href="lis_sucesos_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes8.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('8').'</a></td>';
										echo '<td><a target="_blank" href="lis_sucesos_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes9.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('9').'</a></td>';
										echo '<td><a target="_blank" href="lis_sucesos_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes10.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('10').'</a></td>';
										echo '<td><a target="_blank" href="lis_sucesos_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes11.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('11').'</a></td>';
										echo '<td><a target="_blank" href="lis_sucesos_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes12.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('12').'</a></td>';
									echo '</tr>';
