...
<html lang="en">
<head>
  <title>Formulario Ingreso de Sucesos</title>
  <meta charset="utf-8">
		...
		$(document).ready(function() {
			...
			$("#contactform").validate({
				rules: {
					...
					titulo: { minlength: 2, maxlength: 200},
					fuente: { required: true, maxlength: 200},
...
<body>
	...
	<div class="col-sm-8">
	    ...
	    <div class="panel-heading">Ingresos de Sucesos</div>
