<?php
	...
	$sql_sucesos = $db->Prepare("SELECT suceso_id, fecha_suceso As fecha_suceso, delito_id, delito_detalle_id,
		...
		WHERE YEAR(fecha_suceso) = '$ano' AND s.municipio_id = $muni_id AND s.delito_detalle_id = $delito_deta");
...
<html lang="en">
<head>
    <title>Listado de Homicidios años</title>
    <meta charset="utf-8">
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="panel panel-primary">
				<div class="panel-heading">Listado de Homicidios A&ntilde;o, <?php echo $ano?> Muncipio Caroni, <?php echo $muni_id?>: </div>
