<?php
	...
	$sql_sucesos_ano_meses = $db->Prepare("SELECT YEAR(fecha_suceso) AS ano,
		...
		FROM sucesos
		WHERE YEAR(fecha_suceso) = $ano AND delito_detalle_id = $delito_deta");
	...
	$sql_sucesos_ano_meses_1 = $db->Prepare("SELECT YEAR(fecha_suceso) AS ano,
		...
		FROM sucesos
		WHERE YEAR(fecha_suceso) = $ano-1 AND delito_detalle_id = $delito_deta");
	...
	$sql_sucesos_ano_meses_2 = $db->Prepare("SELECT YEAR(fecha_suceso) AS ano,
		...
		FROM sucesos
		WHERE YEAR(fecha_suceso) = $ano-2 AND delito_detalle_id = $delito_deta");
	...
	$sql_sucesos_ano_meses_3 = $db->Prepare("SELECT YEAR(fecha_suceso) AS ano,
		...
		FROM sucesos
		WHERE YEAR(fecha_suceso) = $ano-3 AND delito_detalle_id = $delito_deta");
	$db->SetFetchMode(ADODB_FETCH_ASSOC);
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="panel panel-primary">
				<div class="panel-heading">Listado Historico de Homicidios Estado Bolivar</div>
							...
							<?php 
								...
								while(!$rs_sucesos_a_m->EOF){
									echo '<tr>';
										...
										echo '<td><a target="_blank" href="lis_homicidios_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes1.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('1').'</a></td>';
										echo '<td><a target="_blank" href="lis_homicidios_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes2.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('2').'</a></td>';
										echo '<td><a target="_blank" href="lis_homicidios_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes3.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('3').'</a></td>';
										echo '<td><a target="_blank" href="lis_homicidios_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes4.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('4').'</a></td>';
										echo '<td><a target="_blank" href="lis_homicidios_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes5.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('5').'</a></td>';
										echo '<td><a target="_blank" href="lis_homicidios_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes6.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('6').'</a></td>';
										echo '<td><a target="_blank" href="lis_homicidios_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes7.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('7').'</a></td>';
										echo '<td><a target="_blank" href="lis_homicidios_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes8.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('8').'</a></td>';
										echo '<td><a target="_blank" href="lis_homicidios_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes9.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('9').'</a></td>';
										echo '<td><a target="_blank" href="lis_homicidios_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes10.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('10').'</a></td>';
										echo '<td><a target="_blank" href="lis_homicidios_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes11.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('11').'</a></td>';
										echo '<td><a target="_blank" href="lis_homicidios_con_ano_mes.php?ano='.$rs_sucesos_a_m->Fields('ano').'&mes='.$mes12.'" class="btn btn-primary btn-sm">'.$rs_sucesos_a_m->Fields('12').'</a></td>';
									echo '</tr>';
