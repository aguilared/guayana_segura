...
<?php
	...
	<?php
		...
		$query_homici_ano_2016 = $db->Prepare("SELECT total AS acu_ano_2016 FROM  `histo_homicidios` WHERE ano =2016");
...
<?php else : ?> <!-- //fin login_check-->
	<p><span class="error">No está autorizado para acceder a esta página.</span> Please <a href="../index.php">login</a>.</p>
<?php endif; ?>
