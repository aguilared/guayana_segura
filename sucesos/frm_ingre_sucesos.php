		...
		$(document).ready(function() {
			...
			$("#contactform").validate({
				...
				submitHandler: function(form){
					var dataString = 'fecha='+$('#fecha').val()+'&delito_id='+$("select#delito_id").val()+'&delito_detalle_id='+$("select#delito_detalle_id").val()+'&titulo='+$('#titulo').val()+'&fuente='+$('#fuente').val()+'&municipio='+$("select#municipio").val()+'&parroquia='+$("select#parroquia").val()+'&nombre_victima='+$('#nombre_victima').val()+'...';
					alert(dataString);
					$.ajax({
						type: "POST",
      ...
      <div class="modal-body">
	    ...
	    <div class="panel-body">
	          ...
	          <form class="form-inline" role="form" id="contactform">
	            ...
	            <div class="form-group"><label for="sel1">Delito</label>	              
	            ...
	            <div class="form-group"><label for="sel2">Detalle Delito</label>
                ...
                <div class="form-group"><label for="titulo">Titulossss:</label>
               ...
               <div class="form-group"><label for="fuente">Fuente:</label>
				...
				<div class="form-group form-group-sm"><label class="col-sm-2 control-label" for="formGroupInputSmall">Small label</label>
					<div class="col-sm-10">
                ...
                <div class="form-group">
	              ...
	              <input class="form-control" name="ingresa" id="ingresa" type="text">
	            </div>
                <div class="clear"></div>
