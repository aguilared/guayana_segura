...
<body>
    <!-- <div class="map-responsive" id="map" style="width: 740px; height: 640px;"></div> -->
	...
	<!-- <iframe src="" id="map" width="600" height="450" frameborder="0" style="border:0"></iframe> -->
    ...
    <script>
      ...
      function initMap() {
        ...
        var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 12,
          center: {lat: 8.319086, lng: -62.978459},
          mapTypeId: 'terrain'
        });
        ...
        var chiricaCoords = [
          ...
          {lat: 8.28938, lng: -62.63468}, //Limite yocoima frent a fracisca duarte
        ...
        var pozoverdeCoords = [
          ...
          {lat: 8.29201, lng: -62.63401}, // en via al pao curva 1
        ...
        var yocoimaCoords = [
          ...
          {lat: 8.27541, lng: -62.46053},// Limite norte  este 

          {lat: 8.34474, lng: -62.59473}, //la  Victoria
