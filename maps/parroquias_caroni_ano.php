...
<body>
	...
	<div class="panel panel-default">
		<div class="panel-heading"><?php echo $today;?>, Homicidios por Parroquias, Municipio <?php echo $muni_descri;?>, Estado <?php echo $estado_descri;?>, A&ntilde;o <?php echo $ano; ?> Total Homicidios:  <?php echo $tot_homi_ano;?>
		</div>
		...
		<div class="panel-footer clearfix">
			<div class="pull-left">Total de Homicidios este año: <?php echo $tot_homi_ano;?></div>
		</div>
	</div>
    ...
    <script>
      ...
      function initMap() {
        ...
        var locations = [
          ...
          [chirica, 8.33080042232, -62.63884948730, 9, '../sucesos/lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_chi?>'],
          ...
          [oncedeabril, 8.3733954392, -62.62794971466, 7, '../sucesos/lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_once?>'],
          ...
          [simonbolivar, 8.35255288448, -62.6670885086, 5, '../sucesos/lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_simon?>'],
          ...
          [vistalsol, 8.3425111123, -62.6166200637, 2, '../sucesos/lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_vista?>'],
          [yocoima, 8.30969987463, -62.60404876708, 1, '../sucesos/lis_homicidios_con_ano_mes_caro_parro.php?ano=<?php echo $ano?>&mes=<?php echo $mes?>&parro=<?php echo $parro_yoco?>']
        ];
