...
<head>
 ...
 <script type="text/javascript">
   ...
   function initMap() {
     var latLng = new google.maps.LatLng(8.315, -62.68);
     var homeLatLng = new google.maps.LatLng(8.315, -62.68);
     ...
     var marker2 = new MarkerWithLabel({
       position: new google.maps.LatLng(8.3098506927, -62.7175140380),
       draggable: true,
       raiseOnDrag: true,
       map: map,
       labelContent: "Cachamay",
