<?php
  ...
  $mysqli= new mysqli("localhost","root","","venezuela_segura");
    ...
    $myquery = "SELECT * FROM sucesos ORDER BY fecha_suceso";
    ...
    while($fila = $resultado ->fetch_assoc())
    {
      ...
      $fechan = $fila["fecha_suceso"];
      $fechan = normaliza($fechan);
      $fechan = $fechan." " .$fila["hora"];
  		
      //echo $fila["suceso_id"]. " ". $fila["fecha_suceso"]. " ". $fechan."<BR>";

      
      $mysqli->query("UPDATE sucesos SET sucesos.fecha_suceso1 = '$fechan' WHERE sucesos.suceso_id = $suceso_id");
